...
<div class="row" ng-controller="SetupCtrl" class="ng-root">
    ...
    <div class='col-md-6 setup-body well'>
        ...
        <form class='setup-form' method='POST' action='/setup'>
            ...
            <input type='text' class='form-control' name='db:name' value='db'>


            <h4>Application Settings</h4>

            <p>Application Name:</p>
            <input type='text' class='form-control' name='app:name' value='url'>
            ...
            <input type='text' class='form-control' name='app:external_url' value='example.com'>
            ...
            <p>Admin Username:</p>
            <input type='text' class='form-control' name='acct:username' value='admin'>

            <p>Admin Email:</p>
            <input type='text' class='form-control' name='acct:email' value='admin@admin.tld'>

            <p>Admin Password:</p>
            <input type='password' class='form-control' name='acct:password' value='admin'>
